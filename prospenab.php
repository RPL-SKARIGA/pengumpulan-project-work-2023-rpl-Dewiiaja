                                ...
                                ?>
                                    ...
                                    <table class="table table-borderless table-striped table-earning">
                                        ...
                                        if (isset($_POST['filter_tgl'])) {
                                            ...
                                            $tgl = date("d-m-Y", strtotime($tgl_absen));
                                        }
                                        $result = mysqli_query($koneksi, "SELECT * FROM tb_absen WHERE waktu_masuk LIKE '%$tgl%'");
